Locales['fr'] = {
  ...
  ['dealer_boss']                     = 'Concess Moto - Patron',
  ['delivered']                       = 'véhicule rendu au Concess Moto',
  ...
  ['paid_rental']                     = 'vous avez payé $%s pour louer une moto avec la plaque %s',
  ['paid_rental_evicted']             = 'vous ne pouviez pas vous permettre de payer $%s pour votre véhicule loué avec la plaque %s, il a été retourné au Concess Moto',
  ['pop_vehicle']                     = 'sortir véhicule',
  ['rent_vehicle']                    = 'Concess Moto - Véhicules en location',
  ['return_provider_menu']            = 'Concess Moto - Retour de véhicule',
  ...
  ['generic_shopitem']                = '$%s',
  ['vehicle_dealer']                  = 'Concess Moto - Véhicules',
